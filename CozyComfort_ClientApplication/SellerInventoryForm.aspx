<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SellerInventoryForm.aspx.cs" Inherits="CozyComfort_ClientApplication.SellerInventoryForm" %>
   ...
   <asp:Content ID="Content1"  ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="navbar">
    <div class="nav-logo">CozyComfort Seller Inventory</div>
    <div class="nav-links">
