<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DistributorInventoryForm.aspx.cs" Inherits="CozyComfort_ClientApplication.DistributorInventoryForm" %>
   ...
   <asp:Content ID="Content1"  ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="navbar">
<div class="nav-logo">CozyComfort Distributor Inventory</div>
<div class="nav-links">
